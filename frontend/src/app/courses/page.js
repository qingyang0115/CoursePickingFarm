...
const Courses = () => {
    ...
    //filter listings based on course code and timeslot. If either filter is empty, it will not filter by that field.
    const filteredListings = listings.filter((listing) => {
        const courseMatch = filterCourse === "" ||
            listing.courseCode.toLowerCase().includes(filterCourse.toLowerCase());
        const slotMatch = filterSlot === "" ||
